...
class AddIncome extends React.Component {
    ...
    handleSubmit = e => {
        ...
        Axios.post(`${CONSTANTS.SERVER_URL}/api/incomes/update/` + this.state._id, payload)
            .then(res => {
    ...
    componentDidMount = () => {
        ...
        Axios.get(`${CONSTANTS.SERVER_URL}/api/incomes/` + this.state._id).then(response => {
            this.setState({
                income_type: response.data.income_type,
                commodity_group: response.data.commodity_group,
                income_for: response.data.income_for,
                income_user: response.data.income_user,
                invoice_no: response.data.invoice_no,
                amount: response.data.amount,
                date_of_income: new Date(response.data.date_of_income),
                income_description: response.data.income_description
            });
            let newOptions = this.state.options;
            if (this.state.income_for === "supplier") {
                newOptions.user = this.state.options.buffer.suppliers;
            }
            else if (this.state.income_for === "consumer") {
                newOptions.user = this.state.options.buffer.consumers;
            }
            this.setState({ options: newOptions })
        }).catch(err => {
                                                    ...
                                                    <FormGroup>
                                                        ...
                                                        <Select
                                                            ...
                                                            value={{
                                                                ...
                                                                label: this.getOptionLabel(this.state.income_type, "income_type", "value", "label"),
                                                            }}
                                                ...
                                                <Col lg="6">
                                                    <FormGroup>
                                                        ...
                                                        <Select
                                                            ...
                                                            value={{
                                                                value: this.state.income_for,
                                                                label: this.state.income_for,
                                                            }}
                                                ...
                                                <Col lg="6">
                                                    <FormGroup>
                                                        ...
                                                        <Select
                                                            ...
                                                            value={{
                                                                value: this.state.income_user,
                                                                label: this.getOptionLabel(this.state.income_user, "user", "value", "label"),
                                                            }}
                                                            onChange={this.handleSelectChange}
                                                        />
                                                    </FormGroup>
