...
export class EditPayment extends React.Component {
    state = {
        ...
        options: {
            ...
            commodities: [
                // {
                //   value: "commodity_group_1",
                //   label: "commodity 1"
                // },
                // {
                //   value: "commodity_group_2",
                //   label: "commodity 2"
                // },
                // {
                //   value: "commodity_group_3",
                //   label: "commodity 3"
                // }
            ],
            buffer: {
    ...
    handleSubmit = e => {
        ...
        Axios.post(`${CONSTANTS.SERVER_URL}/api/payments/update/` + this.state._id, payload)
            .then(res => {
    ...
    handlePaymentTypeChange = props => {
        ...
        if (props.value === "supplier") {
            ...
            newOptions.payment_for = this.state.options.buffer.suppliers;
            ...
            let newOptions = this.state.options;
            newOptions.payment_for = this.state.options.buffer.consumers;
            this.setState({ options: newOptions });
            this.setState({ payment_for: "" });
    ...
    componentDidMount = () => {
        ...
        Axios.get(`${CONSTANTS.SERVER_URL}/api/consumers/`).then(res => {
            ...
            if (res.data.length !== 0) {
                ...
                let newBuffer = this.state.options.buffer;
        ...
        Axios.get(`${CONSTANTS.SERVER_URL}/api/payments/` + this.state._id).then(response => {

            this.setState({
                payment_for: response.data.payment_for,
                payment_type: response.data.payment_type,
                commodity_group: response.data.commodity_group,
                invoice_no: response.data.invoice_no,
                amount: response.data.amount,
                date_of_payment: new Date(response.data.date_of_payment),
                ...
                dd_no: response.data.dd_no,
                cheque_no: response.data.cheque_no,
                my_account_number: response.data.my_account_number,
                my_bank: response.data.my_bank,
            ...
            let newOptions = this.state.options;
            if (this.state.payment_type === "supplier") {
                                                    ...
                                                    <FormGroup>
                                                        ...
                                                        <Select
                                                            ...
                                                            value={{
                                                                ...
                                                                label: this.getOptionLabel(this.state.payment_for, "payment_for", "value", "label"),
                                                            }}
                                                    ...
                                                    <FormGroup>
                                                        ...
                                                        <Select
                                                            ...
                                                            value={{
                                                                ...
                                                                label: this.state.mode_of_payment,
                                                            }}
                    ...
                    <Col lg="6">
                        <FormGroup>
                            ...
                            <Input
                                name="account_number"
                                id="input-account-no"
                                value={this.props.state.account_number}
                                className="form-control-alternative"
                    ...
                    <Col lg="6">
                        <FormGroup>
                            ...
                            <Input
                                ...
                                value={this.props.state.account_holder_name}
                                className="form-control-alternative"
                    ...
                    <Col lg="6">
                        <FormGroup>
                            ...
                            <Select
                                ...
                                value={{
                                    label: this.props.state.my_account_number,
...
export default withSnackbar(EditPayment);
