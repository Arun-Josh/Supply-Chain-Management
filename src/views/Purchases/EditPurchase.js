...
class AddPurchase extends React.Component {
    ...
    handleSubmit = e => {
        ...
        Axios.post(`${CONSTANTS.SERVER_URL}/api/purchases/update/` + this.state._id, payload)
            .then(res => {
                console.log(res);
    ...
    componentDidMount = () => {
        ...
        Axios.get(`${CONSTANTS.SERVER_URL}/api/purchases/` + this.state._id)
            .then(response => {
                this.setState({
                    purchase_for: response.data.purchase_for,
                    commodity_group: response.data.commodity_group,
                    date_of_purchase: new Date(response.data.date_of_purchase),
                    ...
                    purchase_description: response.data.purchase_description,
                            ...
                            <Card className="bg-secondary shadow">
                                <CardHeader className="bg-white border-0">
                                    <Row className="align-items-center">
                                        <Col xs="8">
                                            <h3 className="mb-0">Edit Purchase</h3>
                                        </Col>
                                    </Row>
                                </CardHeader>
                                <CardBody>
                                                ...
                                                <Col lg="12">
                                                    <FormGroup>
                                                        ...
                                                        <Select
                                                            ...
                                                            value={{
                                                                value: this.state.purchase_for,
                                                                label: this.getOptionLabel(this.state.purchase_for, "purchase_for", "value", "label"),
                                                            }}
                                    ...
                                    <div className="pl-lg-4">
                                        <FormGroup>
                                            <Input
                                                ...
                                                value={this.state.purchase_description}
                                                onChange={this.handleChange}
                                            />
                                        </FormGroup>
                                    </div>
