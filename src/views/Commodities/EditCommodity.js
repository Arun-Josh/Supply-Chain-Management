...
class EditCommodity extends React.Component {
    ...
    componentDidMount = () => {
        ...
        Axios.get(`${CONSTANTS.SERVER_URL}/api/commodities/` + this.state._id).then(res => {
            console.log(res.data)
            this.setState({ commodity_group_name: res.data.commodity_group_name, sub_commodities: res.data.sub_commodities });
        }).catch(err => {
    ...
    handleSubmit = e => {
        ...
        payload.sub_commodities.map((commodity, index) => {
            if (!commodity.sub_commodity_name.includes("(")) {
        ...
        Axios.post(`${CONSTANTS.SERVER_URL}/api/commodities/update/` + this.state._id, payload)
            .then(res => {
                if (res.data === "success") {
                    this.props.enqueueSnackbar(
                                                ...
                                                <Col lg="4">
                                                    <FormGroup>
                                                        ...
                                                        <Input
                                                            ...
                                                            type="text"
                                                            value={this.state.sub_commodities[index].sub_commodity_name.split("(")[0]}
                                                            autoComplete="off"
                                                ...
                                                <Col lg="6">
                                                    <FormGroup>
                                                        ...
                                                        <Input
                                                            ...
                                                            type="text"
                                                            autoComplete="off"
                                                            value={this.state.commodity_group_name}
...
export default withSnackbar(EditCommodity);
