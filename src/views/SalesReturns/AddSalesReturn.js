...
class AddSalesReturn extends React.Component {
    ...
    state = {
        sales_return_for: "",            // consumer name / supplier name
        commodity_group: "",            // id
    ...
    handleSubmit = e => {
        ...
        Axios.post(`${CONSTANTS.SERVER_URL}/api/sales-returns/add`, payload)
            .then(res => {
                console.log(res);
                this.props.enqueueSnackbar(
                    `Sales Return saved successfully with invoice #${res.data} `,
                    {
                        variant: "success"
                    }
                );
                                    ...
                                    <div className="pl-lg-4">
                                        <FormGroup>
                                            <Input
                                                className="form-control-alternative"
                                                rows="4"
                                                placeholder="Description about this Sales Return (optional)"
                                                type="textarea"
